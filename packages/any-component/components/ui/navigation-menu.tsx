...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root className={cn('group/navigation-menu relative flex max-w-max flex-1 items-center justify-center', className)} data-slot='navigation-menu' data-viewport={viewport} {...props}>
      {children}
  ...
  return (
    <NavigationMenuPrimitive.Content
      className={cn(
        ...
        'group-data-[viewport=false]/navigation-menu:data-[state=open]:animate-in group-data-[viewport=false]/navigation-menu:data-[state=closed]:animate-out group-data-[viewport=false]/navigation-menu:duration-200',
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      className={cn(
        ...
        'focus-visible:ring-ring/50 focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50',
...
function NavigationMenuViewport({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Viewport>) {
  return (
    <NavigationMenuPrimitive.Viewport
      className={cn(
        'origin-top-center bg-popover text-popover-foreground absolute relative top-full left-0 isolate z-50 mt-1.5 flex justify-center overflow-hidden rounded-md border shadow',
